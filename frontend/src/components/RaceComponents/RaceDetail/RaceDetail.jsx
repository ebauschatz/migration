        ...
        <div>
            ...
            <div className="detail-container">
                <div className="text-details">
                    ...
                    <div className="detail"><span className="detail-label">Finish Opens: </span>{props.race.race_finish_opens}</div>
                    <div className="detail"><span className="detail-label">Finish Closes: </span>{props.race.race_finish_closes}</div>
